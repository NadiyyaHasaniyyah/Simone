                            ...
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    ...
                                    <a class="active" href="{{ route('dashboard_dpt') }}">Dashboard/</a><a
                                        style="color: black" href="{{ route('rekap_pkl') }}">Rekap PKL Mahasiswa</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                  ...
                                  <table class="table table-bordered">
                                    ...
                                    <tbody class="status">
                                        ...
                                        <tr class="data">
                                            ...
                                            {{-- 2017 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[6]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[6]] ?? 0 }}
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[6]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[6]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2018 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[5]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[5]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[5]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[5]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2019 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[4]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[4]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[4]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[4]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2020 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[3]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[3]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[3]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[3]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2021 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[2]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[2]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[2]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[2]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2022 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[1]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[1]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[1]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[1]] ?? 0 }}</a>
                                            </td>

                                            {{-- 2023 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>$angkatanList[0]]) }}" class="text-decoration-none">{{ $countsudah[$angkatanList[0]] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>$angkatanList[0]]) }}" class="text-decoration-none">{{ $countbelum[$angkatanList[0]] ?? 0 }}</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                  </table>
