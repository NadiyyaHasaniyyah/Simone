                                  ...
                                  <table class="table table-bordered">
                                    ...
                                    <tbody class="status">
                                        ...
                                        <tr class="data">
                                            ...
                                            {{-- 2017 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2017']) }}" class="text-decoration-none">{{ $countsudah['2017'] ?? 0 }}
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2017']) }}" class="text-decoration-none">{{ $countbelum['2017'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2018 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2018']) }}" class="text-decoration-none">{{ $countsudah['2018'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2018']) }}" class="text-decoration-none">{{ $countbelum['2018'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2019 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2019']) }}" class="text-decoration-none">{{ $countsudah['2019'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2019']) }}" class="text-decoration-none">{{ $countbelum['2019'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2020 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2020']) }}" class="text-decoration-none">{{ $countsudah['2020'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2020']) }}" class="text-decoration-none">{{ $countbelum['2020'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2021 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2021']) }}" class="text-decoration-none">{{ $countsudah['2021'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2021']) }}" class="text-decoration-none">{{ $countbelum['2021'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2022 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2022']) }}" class="text-decoration-none">{{ $countsudah['2022'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2022']) }}" class="text-decoration-none">{{ $countbelum['2022'] ?? 0 }}</a>
                                            </td>

                                            {{-- 2023 --}}
                                            <td>
                                                <a href="{{ route('list_pkl_sudah', ['angkatan'=>'2023']) }}" class="text-decoration-none">{{ $countsudah['2023'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_pkl_belum', ['angkatan'=>'2023']) }}" class="text-decoration-none">{{ $countbelum['2023'] ?? 0 }}</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                  </table>
