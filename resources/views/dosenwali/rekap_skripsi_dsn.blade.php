                                  ...
                                  <table class="table table-bordered">
                                    ...
                                    <tbody class="status">
                                        ...
                                        <tr class="data">
                                            ...
                                            <td id="2017">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2017']) }}" class="text-decoration-none">{{ $countsudah['2017'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2017']) }}" class="text-decoration-none">{{ $countbelum['2017'] ?? 0 }}</a>
                                            </td>

                                            <td id="2018">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2018']) }}" class="text-decoration-none">{{ $countsudah['2018'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2018']) }}" class="text-decoration-none">{{ $countbelum['2018'] ?? 0 }}</a>
                                            </td>

                                            <td id="2019">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2019']) }}" class="text-decoration-none">{{ $countsudah['2019'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2019']) }}" class="text-decoration-none">{{ $countbelum['2019'] ?? 0 }}</a>
                                            </td>

                                            <td id="2020">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2020']) }}" class="text-decoration-none">{{ $countsudah['2020'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2020']) }}" class="text-decoration-none">{{ $countbelum['2020'] ?? 0 }}</a>
                                            </td>

                                            <td id="2021">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2021']) }}" class="text-decoration-none">{{ $countsudah['2021'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2021']) }}" class="text-decoration-none">{{ $countbelum['2021'] ?? 0 }}</a>
                                            </td>

                                            <td id="2022">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2022']) }}" class="text-decoration-none">{{ $countsudah['2022'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2022']) }}" class="text-decoration-none">{{ $countbelum['2022'] ?? 0 }}</a>
                                            </td>

                                            <td id="2023">
                                                <a href="{{ route('list_skripsi_sudah_dsn', ['angkatan'=>'2023']) }}" class="text-decoration-none">{{ $countsudah['2023'] ?? 0 }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('list_skripsi_belum_dsn', ['angkatan'=>'2023']) }}" class="text-decoration-none">{{ $countbelum['2023'] ?? 0 }}</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                  </table>
