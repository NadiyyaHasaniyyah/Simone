                                    ...
                                    <div class="tabs">
                                        ...
                                        <ul>
                                            <li title="Features"><label for="tab1" role="button"><svg
                                                    ...
                                                    </svg><br><span>Edit PKL</span></label></li>
                                        </ul>
                                            ...
                                            <section>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        {{-- FORM --}}
                                                        <form action="{{ route('pkl_edit_import', ['semester' => $Pkl->semester]) }}" method="POST" enctype="multipart/form-data">
                                                            @method('PUT')
                                                            @csrf
                                                            ...
                                                            <div class="form-group row" style="margin: auto">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <select class="form-control @error('semester') is-invalid @enderror" name="semester" id="semester">
                                                                        ...
                                                                        <option value="1" {{ $Pkl->semester == 1 ? 'selected' : '' }}>1</option>
                                                                        <option value="2" {{ $Pkl->semester == 2 ? 'selected' : '' }}>2</option>
                                                                        <option value="3" {{ $Pkl->semester == 3 ? 'selected' : '' }}>3</option>
                                                                        <option value="4" {{ $Pkl->semester == 4 ? 'selected' : '' }}>4</option>
                                                                        <option value="5" {{ $Pkl->semester == 5 ? 'selected' : '' }}>5</option>
                                                                        <option value="6" {{ $Pkl->semester == 6 ? 'selected' : '' }}>6</option>
                                                                        <option value="7" {{ $Pkl->semester == 7 ? 'selected' : '' }}>7</option>
                                                                        <option value="8" {{ $Pkl->semester == 8 ? 'selected' : '' }}>8</option>
                                                                        <option value="9" {{ $Pkl->semester == 9 ? 'selected' : '' }}>9</option>
                                                                        <option value="10" {{ $Pkl->semester == 10 ? 'selected' : '' }}>10</option>
                                                                        <option value="11" {{ $Pkl->semester == 11 ? 'selected' : '' }}>11</option>
                                                                        <option value="12" {{ $Pkl->semester == 12 ? 'selected' : '' }}>12</option>
                                                                        <option value="13" {{ $Pkl->semester == 13 ? 'selected' : '' }}>13</option>
                                                                        <option value="14" {{ $Pkl->semester == 14 ? 'selected' : '' }}>14</option>
                                                                    </select>
                                                                </div>
