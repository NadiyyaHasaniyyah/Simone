                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody class="status">
                                                ...
                                                <tr class="data">
                                                    ...
                                                    {{-- 2017 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[6]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[6]] ?? 0 }}
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[6]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[6]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2018 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[5]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[5]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[5]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[5]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2019 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[4]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[4]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[4]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[4]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2020 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[3]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[3]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[3]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[3]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2021 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[2]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[2]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[2]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[2]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2022 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[1]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[1]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[1]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[1]] ?? 0 }}</a>
                                                    </td>

                                                    {{-- 2023 --}}
                                                    <td>
                                                        <a href="{{ route('list_pkl_sudah_opt', ['angkatan' => $angkatanList[0]]) }}"
                                                            class="text-decoration-none">{{ $countsudah[$angkatanList[0]] ?? 0 }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('list_pkl_belum_opt', ['angkatan' => $angkatanList[0]]) }}"
                                                            class="text-decoration-none">{{ $countbelum[$angkatanList[0]] ?? 0 }}</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
